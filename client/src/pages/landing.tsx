  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-32 pb-24">
          <div className="text-center space-y-10">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center pt-6">
              ...
              <Button
                ...
                variant="outline"
                onClick={() => setLocation("/login")}
                className="border-2 border-slate-600 text-white hover:bg-white/5 hover:border-slate-500 text-lg h-16 px-10 rounded-2xl font-semibold backdrop-blur-sm group"
