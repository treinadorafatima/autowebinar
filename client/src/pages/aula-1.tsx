...
export default function Aula1Page() {
  const benefits = [
        ...
        <div className="mx-auto px-3 md:px-4" style={{ maxWidth: "960px" }}>
          <div className="text-center mb-4 md:mb-10">
            ...
            >
              ...
              >
                ⭐ AULA 1 - EVANGELHO MATHEUS ⭐
              </div>
              <h1 
                className="text-2xl md:text-5xl lg:text-6xl font-extrabold leading-tight px-2 text-center whitespace-nowrap" 
                style={{ 
