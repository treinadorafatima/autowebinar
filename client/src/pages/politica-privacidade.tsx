        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                <li><button onClick={() => setLocation("/politica-de-privacidade")} className="hover:text-white transition-colors text-blue-400">Política de Privacidade</button></li>
                <li><button onClick={() => setLocation("/termos-de-servico")} className="hover:text-white transition-colors">Termos de Serviço</button></li>
              </ul>
            </div>
          </div>
